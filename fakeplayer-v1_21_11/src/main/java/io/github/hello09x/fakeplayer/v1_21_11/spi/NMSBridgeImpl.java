 ...
 *
 * <p>1.21.11 reuses the NMS implementation written for 1.21.9/1.21.10 (the R6
 * CraftBukkit revision); only the detected version string changes. Identical in
 * spirit to the upstream {@code v1_21_10} module.</p>
 */
